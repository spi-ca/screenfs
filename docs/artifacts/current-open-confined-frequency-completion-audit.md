...
| --- | --- | --- |
| Candidate selection and status are explicit | [`../benchmarks.md`](../benchmarks.md), [`../performance-roadmap.md`](../performance-roadmap.md), and [`current-next-performance-candidates.md`](current-next-performance-candidates.md) now mark the direct opened-object `stat_child_no_follow()` path under `open_confined` and the fast-policy/cache-eligible `readdirplus` page-scan batch fast path as kept claims, while matcher-heavy no-writable mutability is rejected evidence. For current next-priority ordering, defer to `current-next-performance-candidates.md` / `performance-roadmap.md` rather than this historical completion readout. | Satisfied |
...
| --- | --- | --- |
| `readdirplus` page/scan | `claim` | [`readdirplus-page-scan-claim/summary.md`](readdirplus-page-scan-claim/summary.md), [`current-next-performance-candidates.md`](current-next-performance-candidates.md), [`readdirplus-deferred-attrs/summary.md`](readdirplus-deferred-attrs/summary.md) |
...
| matcher-heavy policy path | `smoke` | [`matcher-no-writable-mutability-fast-path/summary.md`](matcher-no-writable-mutability-fast-path/summary.md), with [`current-policy-heavy-matrix-smoke.md`](current-policy-heavy-matrix-smoke.md) and [`current-matcher-descendant-directory-smoke.md`](current-matcher-descendant-directory-smoke.md) as attribution/context |
